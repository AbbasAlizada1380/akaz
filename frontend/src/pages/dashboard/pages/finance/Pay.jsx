                ...
                <table className="w-full">
                  <thead className="bg-primary">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-left text-sm font-semibold text-white">Seller</th>
                      ...
                      <tr>
                        <td colSpan="6" className="px-6 py-16 text-center">
                          <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm text-gray-500 mt-1">Create your first payment using the form above</p>
                          </div>
                        </td>
                      </tr>
                    ) : (
                          ...
                          <td className="px-6 py-4">
                            <div className="flex space-x-2">
                              <button
                                ...
                                className="p-2 text-blue-600 rounded-lg hover:bg-blue-100 transition-all transform hover:scale-105"
                                title="Edit payment"
                              >
