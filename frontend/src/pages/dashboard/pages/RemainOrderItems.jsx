      ...
      <div className="flex items-center justify-between bg-gradient-to-r from-cyan-800 to-cyan-600 text-white rounded-t-lg p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/80">
              باقیمانده کل: <span className="font-semibold">{remainingMoney.toLocaleString()}</span>
            </p>
          </div>
        </div>
      ...
      <div className="p-4">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">هیچ سفارشی برای این مشتری یافت نشد</p>
          </div>
        ) : (
          <>
            {/* Table */}
              ...
              <table className="w-full text-center">
                <thead className="bg-cyan-50 text-cyan-800">
                  <tr>
                    ...
                    <th className="p-3 border-b font-semibold">نام محصول</th>
                    <th className="p-3 border-b font-semibold">تعداد</th>
                    <th className="p-3 border-b font-semibold">قیمت واحد (افغانی)</th>
                    <th className="p-3 border-b font-semibold">مبلغ کل (افغانی)</th>
                    <th className="p-3 border-b font-semibold">پرداخت شده (افغانی)</th>
                    <th className="p-3 border-b font-semibold">باقیمانده (افغانی)</th>
