...
const SellForm = ({
  ...
  return (
    <form onSubmit={onSubmit} className="divide-y divide-gray-200">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          if (selectedProduct) {
                            ...
                            updateItem(item.id, "unitPrice", defaultPrice);
                          } else {
                            updateItem(item.id, "productId", "");
                            updateItem(item.id, "productName", "");
                          }
                        ...
                        className="block w-48 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
                      >
      ...
      {/* Payment & Notes section (unchanged) */}
      <div className="px-6 py-6 sm:px-8">
